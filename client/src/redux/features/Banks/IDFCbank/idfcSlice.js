...
const idfcSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getAllIdfcDetails.pending, (state) => {
        state.loading = true;
      })
      .addCase(getAllIdfcDetails.fulfilled, (state, action) => {
        state.loading = false;
        state.details = action.payload;
      })
      .addCase(getAllIdfcDetails.rejected, (state, action) => {
        state.loading = false;
        state.error = action.payload;
      })
...
export const { clearMessage, clearSingleDetail } = idfcSlice.actions;
export default idfcSlice.reducer;
