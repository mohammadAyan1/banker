    ...
    <div className="p-4">
      ...
      <div className="custom-container mb-6 mt-14 border-b border-gray-300">
        <ul className="nav nav-tabs custom-tabs flex gap-2">
          <li>
            <button
              className={`px-4 py-2 rounded-t-lg font-medium ${activeTab === "dashboard"
          ...
          <li>
            <button
              className={`px-4 py-2 rounded-t-lg font-medium ${activeTab === "myworklist"
                ? "bg-[#B5121B] text-white"
                : "bg-gray-100 text-gray-800"
                }`}
              onClick={() => {
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-7 gap-4 mb-6">
                {reports.map((r, i) => (
                  <div
                    ...
                    className={`group relative flex flex-col items-center text-center p-4 h-36 rounded-xl cursor-pointer transition-all border shadow hover:shadow-lg ${activeComponent === r.component
                    ...
                    {loading ? (
                      ...
                      paginatedBankCases.map((rec, idx) => {
                        ...
                        switch (selectedBankView) {
                          ...
                          case "Home First Trench":
                            // Code to execute
                            bank = "home-first-trench"
                            break;
