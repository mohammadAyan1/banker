...
// const ValuationDetails = ({ isEdit, onNext, onBack }) => {
...
//         <Form.Item label='Land Rate' name='landRate'>
//           <Input type='text' />
//         </Form.Item>
...
//         <Form.Item label='Construction Rate' name='constructionRate'>
//           <Input type='text' />
//         </Form.Item>
...
//         <Form.Item label='Valuation Remarks' name='valuationRemarks'>
//           <Input />
//         </Form.Item>
...
//   <div className="flex-1">
//     <Form.Item label="GF" name="GF">
//       <Input type="text" style={{ width: "100%" }} />
//     </Form.Item>
//   </div>

//   <div className="flex-1">
//     <Form.Item label="FF" name="FF">
//       <Input type="text" style={{ width: "100%" }} />
//     </Form.Item>
//   </div>

//   <div className="flex-1">
//     <Form.Item label="SF" name="SF">
//       <Input type="text" style={{ width: "100%" }} />
//     </Form.Item>
//   </div>
// </div>
...
//         <Form.Item label="Construction Rate considered per sq. Ft" name="constructionRate">
//           <Input type="text" />
//         </Form.Item>
...
//         <Form.Item label="Fair Market Value/ Total Value of the unit after completion" name="fairMarketValue">
//           <Input type="text" disabled />
//         </Form.Item>

//   <Form.Item label="Valuation at Present Stage " name="ValuationatPresentStage">
//           <Input type="text"  />
//         </Form.Item>

//           <Form.Item label="Valuation as per Govt. Guideline " name="ValuationasperGovtGuideline">
//           <Input type="text"  />
//         </Form.Item>
