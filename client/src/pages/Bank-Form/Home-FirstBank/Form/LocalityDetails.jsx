  ...
  useEffect(() => {
    ...
    if (merged) {
      form.setFieldsValue({
        ...
        proposedRoadWidening: merged.proposedRoadWidening || "",
        cityCentreName: merged.cityCentreName || "",
        drainageConnection: merged.drainageConnection || "",
        waterElectricityConnection: merged.waterElectricityConnection || "",
        ...
        degreeOfRisk: merged.degreeOfRisk || "",
