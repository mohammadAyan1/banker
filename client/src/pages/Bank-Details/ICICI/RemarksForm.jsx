...
const RemarksForm = ({
  ...
  useEffect(() => {
    if (editData) {
      const rawContact = editData.personContact || "";
      ...
      setForm((prev) => ({
        ...
        nfsaCheckRequired: editData.nfsaCheckRequired || "",
        generalObservations: editData.generalObservations || "",
        raleReferences: editData.raleReferences || "",

        valuedUnderMarketPractice:
          editData.valuedUnderMarketPractice || prev.valuedUnderMarketPractice,
        propertyCategorization:
          editData.propertyCategorization || prev.propertyCategorization,

        personName: editData.personName || prev.personName,
        relationshipPerson:
          editData.personRole ||
          editData.relationshipPerson ||
          prev.relationshipPerson,

        countryCode,
        mobileNo,

        siteVisits: editData.siteVisits?.toString() || prev.siteVisits,
        evaluationMode: editData.evaluationMode || prev.evaluationMode,
        rejectionReason: editData.rejectionReason || prev.rejectionReason,

        visitedBy: editData.verifiedBy || editData.visitedBy || prev.visitedBy,
        visitedUserType:
          editData.verificationType ||
          editData.visitedUserType ||
          prev.visitedUserType,

        visitDate: editData.visitDate || prev.visitDate,

        documentsVetted:
          Array.isArray(editData.documentsVetted) &&
          editData.documentsVetted.length > 0
            ? editData.documentsVetted
  ...
  return (
    <div className="pb-28">
      ...
      <div className="border border-[#d6d6d6] mb-8">
      ...
      <div className="grid grid-cols-3 gap-x-32 gap-y-9 mb-14">
        <LineInput
      ...
      <div className="grid grid-cols-3 gap-x-32 mb-24">
        <LineInput
          label="Visited By"
          required
      ...
      <div className="flex justify-end gap-8">
        <Button
          ...
          loading={saving}
          className="w-[195px] h-[58px] bg-[#003b70] hover:bg-[#003b70] text-white text-[18px] font-semibold rounded-[4px]"
        >
          Submit
        </Button>
