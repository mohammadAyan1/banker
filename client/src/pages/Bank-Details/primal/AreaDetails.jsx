...
const AreaDetails = () => {
  const state = useSelector((state) => state.primal);
  const singleDetail = state?.singleDetail;
    ...
    <div className="container mx-auto my-4 p-4 bg-white shadow-md rounded-lg">
      ...
      <div className="mb-4">
        ...
        <p className="font-semibold">
          {singleDetail?.typeOfProperty || "Not Specified"}
        </p>
      </div>
            ...
            {[
              ...
              <tr key={index}>
                ...
                <td className="border border-gray-200 p-2">
                  {singleDetail?.sanctionedArea || "0"}
                </td>
                <td className="border border-gray-200 p-2">
                  {singleDetail?.actualArea || "0"}
                </td>
                <td className="border border-gray-200 p-2">
                  {singleDetail?.finalAreaConsidered || "0"}
                </td>
                <td className="border border-gray-200 p-2">
                  {index === 7
                    ? singleDetail?.overallBUA || "Enter OverAll BUA"
                    : "0"}
                </td>
              </tr>
            ))}
      ...
      <div className="mt-4 border-t pt-4">
        ...
        <div className="mt-4 flex justify-between text-sm">
          <div>
            ...
            <p className="font-semibold">
              {singleDetail?.exteriors || "Non Satisfactory"}
            </p>
          </div>
          <div>
            <p className="text-gray-500">Interiors</p>
            <p className="font-semibold">
              {singleDetail?.interiors || "Non Satisfactory"}
            </p>
          </div>
        </div>
      </div>
