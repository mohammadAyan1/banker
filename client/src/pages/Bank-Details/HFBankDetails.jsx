...
// is wale me manish ne kaam kiya hai, //////////////////////  
...
const HFBankDetails = () => {
  ...
  const userRemarks = savedRemarks.length > 0 ? savedRemarks : buildDefaultRemarks(reportData);
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      */}
      ...
      <style>
        {`
          ...
          @media print {
            ...
            .image-grid img {
              width: 100% !important;
              height: 58mm !important;          /* fixed cell height */
              object-fit: contain !important;    /* ✅ no crop */
              object-position: center !important;
              background: #fff !important;       /* blank area white */
              display: block !important;
            }
      ...
      <div id="report" ref={reportRef} className="valuation-report">
        <div className="p-3 bg-white shadow border" id="reportTable">
          <div id="print-section" className="bg-white shadow-md mt-1 rounded-lg overflow-hidden flex">
            <div className="flex-1 overflow-x-auto">
              <table className="w-full border-collapse border">
                ...
                <tbody className="allow-break">
                  <tr>
                    <td className="border border-black px-4 font-semibold print-photo-cell" colSpan="6">
                      {sortedImages.length === 0 ? (
                        <p className="text-gray-500 p-2">No images uploaded.</p>
                      ) : (
                        <ReactSortable
